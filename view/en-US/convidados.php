                ...
                foreach ($convidados as $convid) {
                    ...
                    ?> >
                        ...
                        ?> >
                            ...
                            <?php echo $convidado->getRes_en_us() ?> <a href="http://www.orquestrasinfonicadorn.com.br/convidado/<?php echo $convidado->getId_convidado(); ?>" target="_self">[More details]</a>
                        </div>
                    </article>
                    <?php
                    $count++;
