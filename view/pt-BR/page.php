...
<html>
    <head>
        ...
        if (isset($_GET["ctd"])) {
            if ($_GET["ctd"] == 'inicio') {
                ...
                ?>
                <link rel="canonical" href="http://www.orquestrasinfonicadorn.com.br/convidados" />
                <meta property="og:url" content="http://www.orquestrasinfonicadorn.com.br/convidados" />
        ...
        <?php
        $server_name = $_SERVER["SERVER_NAME"]; // pega o nome do servidor (www.orquestrasinfonicadorn.com.br)
        $request_uri = $_SERVER["REQUEST_URI"]; // pegar a url requisitada (o que vem após o nome do servidor)

        $arrayUrl = explode('/', $request_uri); //separa as partes da url requisita em um array para retirar a antiga requisição GET do idioma
    ...
    <body>
        ...
        <div class="container-fluid">
            <?php
            include_once 'view/pt-BR/header.php';
            ?>
            <div class="row">
                <main class="col-md-12 main-body">
                    ...
                    if (isset($_GET["ctd"])):
                        if ($_GET["ctd"] == 'inicio'):
                            include_once 'view/pt-BR/home.php';
                        elseif ($_GET["ctd"] == 'orquestra'):
                            include_once 'view/pt-BR/orquestra.php';
                        elseif ($_GET["ctd"] == 'agenda'):
                            include_once 'view/pt-BR/agenda.php';
                        elseif ($_GET["ctd"] == 'contato'):
                            include_once 'view/pt-BR/contato.php';
                        elseif ($_GET["ctd"] == 'convidados'):
                            include_once 'view/pt-BR/convidados.php';
                        elseif ($_GET["ctd"] == 'convidado'):
                            include_once 'view/pt-BR/convidado.php';
                        elseif ($_GET["ctd"] == 'imagens'):
                            include_once 'view/pt-BR/imagens.php';
                        elseif ($_GET["ctd"] == 'videos'):
                            include_once 'view/pt-BR/videos.php';
                        elseif ($_GET["ctd"] == 'noticias'):
                            include_once 'view/pt-BR/noticias.php';
                        elseif ($_GET["ctd"] == 'maestro'):
                            include_once 'view/pt-BR/maestro.php';
                        elseif ($_GET["ctd"] == 'musicos'):
                            include_once 'view/pt-BR/musicos.php';
                        elseif ($_GET['ctd'] == 'performances'):
                            include_once 'view/pt-BR/performances.php';
                        else:
                            include_once 'view/pt-BR/home.php';
                        endif;
                    else:
        ...
        <?php
        include_once 'view/pt-BR/footer.php';
        ?>
        <script type="text/javascript">
